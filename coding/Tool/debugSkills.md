...
很大缺点：似乎把整个盘都index了，很慢！！！          ------->  TODO: 以前似乎不是这样？？？？
...
很大缺点：一个projectDir会变成一个module ------->  左边目录，无法保持aosp源码目录，没有显示frameworks\\base目录（尤其只需要一部分代码时）
...
![image-20221105223430616](debugSkills.assets/image-20221105223430616.png)
